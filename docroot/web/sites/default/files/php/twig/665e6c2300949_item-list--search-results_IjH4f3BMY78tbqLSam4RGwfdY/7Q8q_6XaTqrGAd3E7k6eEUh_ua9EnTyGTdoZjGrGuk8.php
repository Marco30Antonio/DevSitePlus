...
class __TwigTemplate_fa2e23f346d97d28ecfd28e07d785179 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 25
        $context["classes"] = ["list-group", ($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 27
($context["context"] ?? null), "plugin", [], "any", false, false, true, 27), 27, $this->source) . "-results")];
        // line 30
        $context["attributes"] = twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 30);
        // line 31
        echo "
";
        // line 32
        if (twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "list_style", [], "any", false, false, true, 32)) {
            // line 33
            $context["attributes"] = twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [("item-list__" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "list_style", [], "any", false, false, true, 33), 33, $this->source))], "method", false, false, true, 33);
        }
        // line 35
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/dataset/item-list--search-results.html.twig", "C:\\xampp\\htdocs\\DevSitePlus\\docroot\\web\\themes\\contrib\\bootstrap_barrio\\templates\\dataset\\item-list--search-results.html.twig");
    }
